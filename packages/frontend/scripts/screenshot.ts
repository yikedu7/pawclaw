 ...
 *   pnpm --filter @pawclaw/frontend screenshot
 *   # → /tmp/pawclaw-render.png ready for Read tool multimodal review
 *
 * Env vars:
 ...
 *   SCREENSHOT_OUTPUT    — output path (default: /tmp/pawclaw-render.png)
 */

import { chromium } from "playwright";

const url = process.env.SCREENSHOT_URL ?? "http://localhost:5173";
const output = process.env.SCREENSHOT_OUTPUT ?? "/tmp/pawclaw-render.png";
